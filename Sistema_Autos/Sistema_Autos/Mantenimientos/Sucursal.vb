...
Public Class frmSucursal
    Dim objSucursal As New Sucursal
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        If frmListarSucursal.ShowDialog() = Windows.Forms.DialogResult.OK Then
            Me.objSucursal = frmListarSucursal.objSucursal
            Cargar()
            Habilitar(False)
    ...
    Private Sub frmSucursal_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Limpiar()
    End Sub
    ...
    Sub Grabar()
        Try
            ...
            If Valida() Then
                objSucursal.descripcion = Me.txtdescripcion.Text.Trim
                objSucursal.direccion = Me.txtdireccion.Text.Trim
                objSucursal.telefono = Me.txttelefono.Text.Trim
                If MessageBox.Show("¿Desea registrar los datos de esta sucursal?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    objSucursal = nSucursal.Registrar(objSucursal)
                    MessageBox.Show("Los datos se guardaron satisfactoriamente", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Me.lblCodigo.Text = objSucursal.id_sucursal
    ...
    Sub Modificar()
        Try
            ...
            nSucursal.Modificar(New Sucursal(CInt(Me.lblCodigo.Text), Me.txtdescripcion.Text.Trim, Me.txtdireccion.Text.Trim, Me.txttelefono.Text.Trim))
            ...
            objSucursal.id_sucursal = Me.lblCodigo.Text
            objSucursal.descripcion = Me.txtdescripcion.Text.Trim
            objSucursal.direccion = Me.txtdireccion.Text.Trim
            objSucursal.telefono = Me.txttelefono.Text.Trim
    ...
    Sub Eliminar()
        Try
            ...
            If MessageBox.Show("¿Desea eliminar los datos de esta sucursal?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                nSucursal.Eliminar(lblCodigo.Text)
    ...
    Sub Cargar()
        Try
            ...
            Me.lblCodigo.Text = objSucursal.id_sucursal
            Me.txtdescripcion.Text = objSucursal.descripcion
            Me.txtdireccion.Text = objSucursal.direccion
            Me.txttelefono.Text = objSucursal.telefono
            Me.lblCodigo.Visible = True
    ...
    '-----------------VALIDACIONES
    '---------------------------------------------
    Private Sub validaNumero_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txttelefono.KeyPress
    ...
    Function Valida() As Boolean
        ...
        If Me.txtdescripcion.Text.Trim = "" Then
            TextoError = TextoError & "- Debe ingresar una descripción." & vbCrLf
        End If
