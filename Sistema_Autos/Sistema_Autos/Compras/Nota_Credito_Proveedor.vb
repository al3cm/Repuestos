...
Public Class frmNota_Credito_Proveedor
    ...
    Dim objNota_Credito_Proveedor As New Nota_Credito_Proveedor
    ...
    '---------------------------------------------
    'Added 2014.03.26
    Private Sub frmNota_Credito_Proveedor_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Limpiar()
    End Sub
    Private Sub frmNota_Credito_Proveedor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ' LÓGICA PERMISOS -------------------------------------------------
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        If frmBuscar_Nota_Credito_Proveedor.ShowDialog = Windows.Forms.DialogResult.OK Then
            Me.objNota_Credito_Proveedor = frmBuscar_Nota_Credito_Proveedor.objNota_Credito_Proveedor
            Cargar()
            Habilitar(False)
            btnGrabar.Enabled = False
            btnModificar.Tag = "Modificar"
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        ...
        Dim TextoError As String = "" ' Added 2014.03.26
        estado = True
    ...
    Sub Grabar()
        Try
            If Valida() Then
                objNota_Credito_Proveedor.fecha_emision = Me.dtpfecha_emision.Value
                objNota_Credito_Proveedor.total = Me.TxtTotal.Text.Trim
                objNota_Credito_Proveedor.subtotal = Me.txtPrecio_neto.Text.Trim
                objNota_Credito_Proveedor.igv = Me.txtigv.Text.Trim
                objNota_Credito_Proveedor.serie_nota_credito = Me.txtserie_documento.Text.ToString
                objNota_Credito_Proveedor.nro_nota_credito = Me.txtnro_documento.Text.ToString
                objNota_Credito_Proveedor.id_compra = Me.TxtIdOrden.Text.ToString
                objNota_Credito_Proveedor.Motivo = Me.cboMotivo.SelectedValue
                objNota_Credito_Proveedor.id_tipodocumento = Me.cbotipo_comprobante.SelectedValue
                objNota_Credito_Proveedor.Saldo_Pendiente = Me.txtsaldo_pendiente.Text.ToString
                ...
                If MessageBox.Show("¿Desea registrar los datos de este Nota de Credito?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    ...
                    Try
                        For i As Integer = 0 To Dgv.RowCount - 1
                            objNota_Credito_Proveedor.id_producto = CInt(Dgv.Item(0, i).Value)
                            objNota_Credito_Proveedor.cantidad = CInt(Dgv.Item(2, i).Value)
                            objNota_Credito_Proveedor.precio_compra = CDbl(Dgv.Item(4, i).Value)
                            objNota_Credito_Proveedor.descuento = CDbl(Dgv.Item(5, i).Value)
                            objNota_Credito_Proveedor.Sub_Total = CDbl(Dgv.Item(6, i).Value)
                            If objNota_Credito_Proveedor.id_producto <> 0 Then
                                nNota_Credito_Proveedor.RegistrarDetalle_Nota_Credito_Proveedor(objNota_Credito_Proveedor)
                                If Me.rbtDevolucion.Checked Then
                                    Dim Tabla As DataTable
                                    objKardex.id_producto = objNota_Credito_Proveedor.id_producto
                                    objKardex.cantidad = objNota_Credito_Proveedor.cantidad
                                    objKardex.precio = objNota_Credito_Proveedor.precio_compra
                                    objKardex.Descuentro = objNota_Credito_Proveedor.descuento
                                    objKardex.total = objNota_Credito_Proveedor.Sub_Total
    ...
    Sub Modificar()
        Try
            ...
            objNota_Credito_Proveedor.id_tipodocumento = Me.cbotipo_comprobante.SelectedValue
            objNota_Credito_Proveedor.Saldo_Pendiente = Me.txtsaldo_pendiente.Text.ToString
            nNota_Credito_Proveedor.ModificarNota_Credito_Proveedor(objNota_Credito_Proveedor)
            Dim Dgv As DataGridView
            Dgv = Me.dtvListado_Productos
            nNota_Credito_Proveedor.EleminarDetalle_Nota_Credito_Proveedor(objNota_Credito_Proveedor.id_nota_credito)
            Try
                For i As Integer = 0 To Dgv.RowCount - 1
                    objNota_Credito_Proveedor.id_producto = CInt(Dgv.Item(0, i).Value)
                    objNota_Credito_Proveedor.cantidad = CInt(Dgv.Item(2, i).Value)
    ...
    Sub Eliminar()
        Try
            If MessageBox.Show("¿Desea eliminar los datos de este Orden de Compra?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                nNota_Credito_Proveedor.EleminarNota_Credito_Proveedor(lblCodigo.Text)
                nNota_Credito_Proveedor.EleminarDetalle_Nota_Credito_Proveedor(lblCodigo.Text)
    ...
    Sub Cargar()
        Try
            ...
            Dim suma As Double
            Tabla = nNota_Credito_Proveedor.Listar(objNota_Credito_Proveedor.id_nota_credito)
            For Each Fila As DataRow In Tabla.Rows
                objNota_Credito_Proveedor.fecha_emision = Fila.Item("fecha_emision")
                objNota_Credito_Proveedor.total = Fila.Item("total")
                objNota_Credito_Proveedor.subtotal = Fila.Item("subtotal")
                objNota_Credito_Proveedor.igv = Fila.Item("igv")
                objNota_Credito_Proveedor.nro_nota_credito = Fila.Item("nro_nota_credito")
                objNota_Credito_Proveedor.serie_nota_credito = Fila.Item("serie_nota_credito")
                objNota_Credito_Proveedor.id_nota_credito = Fila.Item("id_nota_credito")
                objNota_Credito_Proveedor.Motivo = Fila.Item("Motivo")
                objNota_Credito_Proveedor.Saldo_Pendiente = Fila.Item("saldo_pendiente")
            Next
            Me.lblCodigo.Text = objNota_Credito_Proveedor.id_nota_credito
            Me.txtserie_documento.Text = objNota_Credito_Proveedor.serie_nota_credito
            Me.txtnro_documento.Text = objNota_Credito_Proveedor.nro_nota_credito
            Me.TxtIdOrden.Text = objNota_Credito_Proveedor.id_compra
            Me.dtpfecha_emision.Value = objNota_Credito_Proveedor.fecha_emision
            Me.txtPrecio_neto.Text = objNota_Credito_Proveedor.subtotal
            Me.txtigv.Text = objNota_Credito_Proveedor.igv
            Me.TxtTotal.Text = objNota_Credito_Proveedor.total
            Me.cboMotivo.SelectedValue = objNota_Credito_Proveedor.Motivo
            Me.txtsaldo_pendiente.Text = objNota_Credito_Proveedor.Saldo_Pendiente
            Tabla = nNota_Credito_Proveedor.ListarDetalle(objNota_Credito_Proveedor.id_nota_credito)
            ToDescuento = 0.0
            suma = 0.0
            ...
            For Each Fila As DataRow In Tabla.Rows
                ...
                objNota_Credito_Proveedor.id_compra = Fila.Item("id_compra")
                Me.dtvListado_Productos.Rows.Add(Id_Producto, Producto, Cantidad, Unidad, costo, Descuento, Total)
            ...
            End If
            Me.TxtIdOrden.Text = objNota_Credito_Proveedor.id_compra
            Tabla = nOrden_Compra.Listar(objNota_Credito_Proveedor.id_compra)
            For Each Fila As DataRow In Tabla.Rows
    ...
    Sub Limpiar()
        ...
        Me.txtserie_documento.Enabled = False
        Me.dtpfecha_comprobante.Enabled = False
    ...
    Sub BuscarSerie()
        ...
        Dim serie As String
        id_Compra = nNota_Credito_Proveedor.buscarid
