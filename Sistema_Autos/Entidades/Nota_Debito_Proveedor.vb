Public Class Nota_Debito_Proveedor
    Private mid_nota_debito As Integer
    Private mnro_nota_debito As String
    Private mserie_nota_debito As String
    ...
    Public Property id_nota_debito() As Integer
        Get
            Return mid_nota_debito
        End Get
        Set(ByVal value As Integer)
            mid_nota_debito = value
        End Set
    End Property
    Public Property nro_nota_debito() As String
        Get
            Return mnro_nota_debito
        End Get
        Set(ByVal value As String)
            mnro_nota_debito = value
        End Set
    End Property
    Public Property serie_nota_debito() As String
        Get
            Return mserie_nota_debito
        End Get
        Set(ByVal value As String)
            mserie_nota_debito = value
        End Set
    End Property
